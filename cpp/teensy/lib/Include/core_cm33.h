...
#define TPI_ITFTTD0_ATB_IF2_bytecount_Msk                                      \
    (0x3UL                                                                     \
     << TPI_ITFTTD0_ATB_IF2_bytecount_Pos) /*!< TPI ITFTTD0: ATB Interface     \
                                              2 byte count Mask */
...
#define TPI_ITFTTD0_ATB_IF1_bytecount_Msk                                      \
    (0x3UL                                                                     \
     << TPI_ITFTTD0_ATB_IF1_bytecount_Pos) /*!< TPI ITFTTD0: ATB Interface     \
                                              1 byte countt Mask */
...
#define TPI_ITFTTD1_ATB_IF2_bytecount_Msk                                      \
    (0x3UL                                                                     \
     << TPI_ITFTTD1_ATB_IF2_bytecount_Pos) /*!< TPI ITFTTD1: ATB Interface     \
                                              2 byte count Mask */
...
#define TPI_ITFTTD1_ATB_IF1_bytecount_Msk                                      \
    (0x3UL                                                                     \
     << TPI_ITFTTD1_ATB_IF1_bytecount_Pos) /*!< TPI ITFTTD1: ATB Interface     \
                                              1 byte countt Mask */
...
#define SysTick_BASE_NS                                                        \
    (SCS_BASE_NS +                                                             \
     0x0010UL) /*!< SysTick Base Address              (non-secure              \
                  address space) */
#define NVIC_BASE_NS                                                           \
    (SCS_BASE_NS +                                                             \
     0x0100UL) /*!< NVIC Base Address                 (non-secure              \
                  address space) */
#define SCB_BASE_NS                                                            \
...
#define FPU_BASE_NS                                                            \
    (SCS_BASE_NS +                                                             \
     0x0F30UL) /*!< Floating Point Unit               (non-secure              \
                  address space) */
#define FPU_NS                                                                 \
    ((FPU_Type*)                                                               \
         FPU_BASE_NS) /*!< Floating Point Unit               (non-secure       \
                         address space) */

/*
    ...
    - the datasheet is unclear about the number of GPTs, the text says 1, the
...
/// this was created to be used for delays in the nanoseconds range, but did't
/// work reliably. Probably because the time of execution of the different lines
/// where not compensated. ----> USE the inbuilt function delaynanoseconds
/// INSTEAD !!!!!!!!!!!!!!!!!!!!!!!!!! -----------------------------

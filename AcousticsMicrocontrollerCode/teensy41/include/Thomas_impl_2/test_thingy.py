...
def calculate_tdoa(ref, pos):
    return (1/v)*(np.sqrt((pos[0]-pinger_pos[0])**2+(pos[1]-pinger_pos[1])**2+(pos[2]-pinger_pos[2])**2)-np.sqrt((ref[0]-pinger_pos[0])**2+(ref[1]-pinger_pos[1])**2+(ref[2]-pinger_pos[2])**2))
 

#Time difference between hydrophone 0 and hydrophone number i
tdoa_01 = calculate_tdoa(hydrophone_array[0], hydrophone_array[1])
tdoa_02 = calculate_tdoa(hydrophone_array[0], hydrophone_array[2])
tdoa_03 = calculate_tdoa(hydrophone_array[0], hydrophone_array[3])
tdoa_04 = calculate_tdoa(hydrophone_array[0], hydrophone_array[4])
...
print(f"Timedifference: [{tdoa_01}, {tdoa_02}, {tdoa_03}, {tdoa_04}]")